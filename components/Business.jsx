        ...
        <section className="bg-[url('/assets/images/bg-business.png')] bg-cover bg-center">
            <div className='container' ref={sectionRef}>
                <div className="text-center mb-16 max-w-[1000px] mx-auto">
                    <h2 className="text-4xl font-bold text-gray-900">Grow A Business That Matches Your <span className="text-sky">Vision For Success.</span></h2>
                    <p className="mt-4 text-xl text-gray">Simplify your multichannel operations with OneClick OMS. Manage your inventory centrally and enjoy powerful features, so you can spend more time on what you love.</p>
                </div>
                <div className="grid grid-cols-1 gap-16">
                    <div className="flex items-center justify-start">
                        <div className='h-full w-full md:w-[500px] md:h-[350px] md:relative flex flex-col md:flex-row'>
                            <div className="h-full w-full md:w-[238px] md:h-[238px] mb-6 md:absolute md:top-0 md:right-0 mx-auto">
                                <Image src="/assets/images/Reclaim Your Time 1.png" alt="Clock Icon" width={238} height={238} className="w-full h-full animate-moveInHexagon" />
                            </div>
                            <div className='pt-auto flex flex-col justify-end'>
                                <h3 className="text-4xl font-semibold text-black mb-4">Reclaim Your<br /> Schedule And Your Freedom.</h3>
                    ...
                    <div className="flex items-center justify-end">
                        <div className='h-full w-full md:w-[500px] md:h-[350px] md:relative flex flex-col md:flex-row'>
                            <div className="h-full w-full md:w-[238px] md:h-[238px] mb-6 md:absolute md:top-0 md:right-0 mx-auto">
                                <Image src="/assets/images/Mark.png" alt="Mark Icon" width={238} height={238} className="w-full h-full animate-moveInHexagon" />
                            </div>
                            <div className='pt-auto flex flex-col justify-end'>
                                <h3 className="text-4xl font-semibold text-black mb-4">Make Smarter<br /> Choices With Ease.</h3>
                                <p className="text-gray text-xl">
                    ...
                    <div className="flex items-center justify-start">
                        <div className='h-full w-full md:w-[500px] md:h-[350px] md:relative flex flex-col md:flex-row'>
                            <div className="h-full w-full md:w-[238px] md:h-[238px] mb-6 md:absolute md:top-0 md:right-0 mx-auto">
                                <Image src="/assets/images/Grow.png" alt="Grow Icon" width={238} height={238} className="w-full h-full animate-moveInHexagon" />
                            </div>
                            <div className='pt-auto flex flex-col justify-end'>
                                <h3 className="text-4xl font-semibold text-black mb-4">Elevate Your<br /> Business Reach</h3>
                                <p className="text-gray text-xl">
